...
(function(ProviderExternalUrl2) {
  ...
  ProviderExternalUrl2["BitKeep"] = "https://web3.bitget.com/en/wallet-download";
...
var metamask = {
  ...
  getIcon: async () => (await import("./metamask-WP222BTU.js")).default,
...
var infinitywallet = {
  ...
  getIcon: async () => (await import("./infinitywallet-BTRQOXYR.js")).default,
...
var exodus = {
  ...
  getIcon: async () => (await import("./exodus-Y5ZQ2H3X.js")).default,
...
var frontier = {
  ...
  getIcon: async () => (await import("./frontier-GNN7H32U.js")).default,
  getInterface: async () => ({
...
var brave = {
  ...
  getIcon: async () => (await import("./brave-JXEVOCCT.js")).default,
...
var binance = {
  ...
  getIcon: async () => (await import("./binance-5Q24WGHC.js")).default,
  getInterface: async () => {
    let tempBNBProvider = {
      ...window.BinanceChain
    };
...
var coinbase = {
  ...
  getIcon: async () => (await import("./coinbase-YGWX5M4N.js")).default,
  getInterface: async () => {
...
var detected = {
  ...
  getIcon: async () => (await import("./detected-JRFXCYN4.js")).default,
  getInterface: async () => ({
...
var trust = {
  ...
  getIcon: async () => (await import("./trust-5PZLBJMP.js")).default,
  getInterface: async () => {
...
var opera = {
  ...
  getIcon: async () => (await import("./opera-BAVX7VVY.js")).default,
  getInterface: async () => ({
...
var status = {
  ...
  getIcon: async () => (await import("./status-DYTEQVDC.js")).default,
  getInterface: async () => {
...
var alphawallet = {
  ...
  getIcon: async () => (await import("./alphawallet-7YAPEMSZ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var apexwallet = {
  ...
  getIcon: async () => (await import("./apexwallet-AG3FNHXH.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
...
var atoken = {
  ...
  getIcon: async () => (await import("./atoken-BMR2L3NI.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var bifrostwallet = {
  ...
  getIcon: async () => (await import("./bifrostwallet-YL56D7JS.js")).default,
...
var bitpie = {
  ...
  getIcon: async () => (await import("./bitpie-JYER6ZAB.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var blockwallet = {
  ...
  getIcon: async () => (await import("./blockwallet-EDIYC2CP.js")).default,
...
var frame = {
  ...
  getIcon: async () => (await import("./frame-YXLVJ4EB.js")).default,
  getInterface: async () => {
    const provider = window.ethereum;
...
var huobiwallet = {
  ...
  getIcon: async () => (await import("./huobiwallet-RAIFWDM5.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var hyperpay = {
  ...
  getIcon: async () => (await import("./hyperpay-L7JAQ6BF.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var imtoken = {
  ...
  getIcon: async () => (await import("./imtoken-UOCVGJMS.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      eth_selectAccounts: UNSUPPORTED_METHOD
    })
...
var liquality = {
  ...
  getIcon: async () => (await import("./liquality-DGPP7YA3.js")).default,
  getInterface: async () => {
...
var meetone = {
  ...
  getIcon: async () => (await import("./meetone-ZYTP4CIX.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var mykey = {
  ...
  getIcon: async () => (await import("./mykey-Z5IYDTQ2.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var ownbit = {
  ...
  getIcon: async () => (await import("./ownbit-JK3NZC4G.js")).default,
  getInterface: async () => {
    const provider = createEIP1193Provider(window.ethereum, {
      eth_chainId: ({ baseRequest }) => baseRequest({ method: "eth_chainId" }).then((id) => `0x${parseInt(id).toString(16)}`),
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
...
var tokenpocket = {
  ...
  getIcon: async () => (await import("./tokenpocket-LCI7R7FA.js")).default,
...
var tp = {
  ...
  getIcon: async () => (await import("./tp-E6ON5ODE.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var xdefi = {
  ...
  getIcon: async () => (await import("./xdefi-RSKL3ISE.js")).default,
  getInterface: async () => ({
...
var oneInch = {
  ...
  getIcon: async () => (await import("./oneInch-BTR4WLS6.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
var tokenary = {
  ...
  getIcon: async () => (await import("./tokenary-EBK6DEKJ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var tally = {
  ...
  getIcon: async () => (await import("./tallywallet-B4ZA25OZ.js")).default,
  getInterface: async () => ({
...
var zeal = {
  ...
  getIcon: async () => (await import("./zeal-S7JWZ2BP.js")).default,
  getInterface: async () => ({
...
var rabby = {
  ...
  getIcon: async () => (await import("./rabby-L744TTIO.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["desktop"]
...
var mathwallet = {
  ...
  getIcon: async () => (await import("./mathwallet-AJVBI3AK.js")).default,
...
var gamestop = {
  ...
  getIcon: async () => (await import("./gamestop-KPMMBJPB.js")).default,
  getInterface: async () => {
...
var bitkeep = {
  ...
  getIcon: async () => (await import("./bitkeep-JBIXK6MO.js")).default,
  getInterface: async () => ({
...
var sequence = {
  ...
  getIcon: async () => (await import("./sequence-55UIXDLN.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["all"]
...
var core = {
  ...
  getIcon: async () => (await import("./core-XAEFBM2W.js")).default,
...
var bitski = {
  ...
  getIcon: async () => (await import("./bitski-TBXEIT5W.js")).default,
  getInterface: async () => ({
...
var zerion = {
  ...
  getIcon: async () => (await import("./zerion-EIJIRDFQ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var enkrypt = {
  ...
  getIcon: async () => (await import("./enkrypt-5KDVVOEU.js")).default,
  getInterface: async () => {
...
var phantom = {
  ...
  getIcon: async () => (await import("./phantom-IUOACIPX.js")).default,
  getInterface: async () => ({
...
var safepal = {
  ...
  getIcon: async () => (await import("./safepal-6ATKP7ZF.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var rainbow = {
  ...
  getIcon: async () => (await import("./rainbow-DFLOGJLF.js")).default,
...
var okxwallet = {
  ...
  getIcon: async () => (await import("./okxwallet-UKIE75OY.js")).default,
  getInterface: async () => ({
...
var defiwallet = {
  ...
  getIcon: async () => (await import("./defiwallet-I3JF4N6H.js")).default,
  getInterface: async () => ({
...
var safeheron = {
  ...
  getIcon: async () => (await import("./safeheron-25MO6D64.js")).default,
  getInterface: async () => ({
...
var talisman = {
  ...
  getIcon: async () => (await import("./talisman-ROWQ47ZO.js")).default,
  getInterface: async () => ({
...
var ronin = {
  ...
  getIcon: async () => (await import("./roninwallet-77EZNM7Y.js")).default,
  getInterface: async () => ({
...
var onekey = {
  ...
  getIcon: async () => (await import("./onekey-3ZR5TTHG.js")).default,
  getInterface: async () => ({
...
var fordefi = {
  ...
  getIcon: async () => (await import("./fordefi-M26IPIAE.js")).default,
...
var coin98wallet = {
  ...
  getIcon: async () => (await import("./coin98wallet-EZUUSTRU.js")).default,
  getInterface: async () => {
    const ethereumInjectionExists = window.hasOwnProperty(InjectedNameSpace.Ethereum);
    let provider;
...
var subwallet = {
  ...
  getIcon: async () => (await import("./subwallet-WZFIMKKS.js")).default,
  getInterface: async () => ({
...
var kayros = {
  ...
  getIcon: async () => (await import("./kayros-HFDY3KVH.js")).default,
  getInterface: async () => ({
